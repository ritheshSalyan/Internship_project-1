...
class _HustleStoreState extends State<HustleStore> {
  ...
  double width, height;
  List<Color> color = [Color.fromRGBO(222, 30, 89, 1),Color.fromRGBO(59, 40, 127, 1)];
  ...
  Future<void> sharedPrefereneData() async {
   ...
   await db.collection("user").where("uid",isEqualTo: userId).getDocuments().then((document){
      document.documents.forEach((value){
                                    ...
                                    Navigator.of(context)
                                      ...
                                      Navigator.of(context)
                                        ...
                                        builder: (context) => ListingData(
                                            title: component.description,index:index),
                                      ));
                                    } else {
                                      if (widget.points >= component.price) {
